...
const SignUp = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (
      ...
      setErrors({
        ...errors,
        username: "El campo  username es obligatorios",
      });
      ...
      setErrors({
        ...errors,
        email: "El campo email es obligatorios",
      });
      return;
    } else if (password === "") {
      setErrors({
        ...errors,
        password: "El campo passoword es obligatorios",
      });
      return;
    } else if (confirm_password === "") {
      setErrors({
        ...errors,
        confirm_password: "El campo confirm_password es obligatorios",
      });
      return;
    } else if (password !== confirm_password) {
      setErrors({
        ...errors,
        all: "Las contraseñas no coinciden",
      });
      return;
    }
    try {
  ...
  return (
    <>
      <main className="singup">
        <div className="title">
          {/* <h1 onClick={(e) => clip(e,"texto")}>Get Started With MAKER</h1> */}
        ...
        {errors.all && <p className="error_all">{errors.all && errors.all}</p>}
        ...
        <form className="form" onSubmit={handleSubmit}>
          <div className="form__inputs">
            ...
            {errors.confirm_password && (
              <ErrorMsg error={errors.confirm_password} />
            )}
          </div>
